/***************************************************************************
*  Projekt 15 - LCD-Display övn 10
*  Inställning av klockans timmar, minuter och väckarklockan,
*  samt visning av rumstemperaturen och RGB-lysdioden tänds med färg röd
*  när alarmen går, med färg gul när temperaturen är högre än 29 och lägre
*  45, annars är RGB-lysdioden tänd med färgen grön.
****************************************************************************/
...
void loop()
{
  ...
  calculateAndDisplayTemperature();
...
************************************************************/
void calculateAndDisplayTemperature()
{
